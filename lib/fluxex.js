...
objectAssign(Fluxex.prototype, {
    ...
    renderHtml: function (action) {
        var self = this;
        return this.executeAction(action).then(function () {
            return self.createPromise(function (resolve) {
                react.withContext({fluxex: self}, function () {
            ...
            for (I in self._stores) {
                if (self._stores.hasOwnProperty(I)) {
                    ...
                    if (cb) {
                        ...
                        cb.call(self._stores[I], payload);
                    }
                }
            }
