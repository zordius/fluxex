var config = {
  ...
  browsers: [
    ...
    {deviceName: 'iPhone Simulator', version:'8.1', platform: 'OS X 10.9'},
    {deviceName: 'iPhone Simulator', version:'8.0', platform: 'OS X 10.9'},
    {deviceName: 'iPhone Simulator', version:'7.1', platform: 'OS X 10.9'},
    {deviceName: 'Phone Simulator', version:'6.1', platform: 'OS X 10.8'},
